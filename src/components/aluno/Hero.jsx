...
const HeroAluno = () => {
  ...
  const handleCTAClick = () => {
    trackButtonClick(trackingEvents.LANDING_ALUNO_CTA_HERO, 'Começar Agora', {
      page: 'landing_aluno',
      section: 'hero'
    });
          ...
          <div className="relative animate-fadeIn delay-300">
            <div className="relative z-10">
              <img 
                ...
                alt="Aluno praticando aulas práticas de direção com instrutor certificado na DriveToPass" 
