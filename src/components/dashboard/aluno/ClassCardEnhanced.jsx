  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow">
      ...
      {classData.rating && (
        <div className="mb-4 p-3 bg-gray-50 rounded-lg">
          <div className="flex items-center mb-2">
            ...
            <span className="ml-2 text-sm text-gray-600">{classData.rating}/5</span>
          </div>
          {classData.review && (
            <p className="text-sm text-gray-600 italic">"{classData.review}"</p>
          )}
        </div>
      )}
      ...
      <div className="flex flex-col sm:flex-row flex-wrap gap-2 pt-4 border-t border-gray-200">
        ...
        {/* Botão Cancelar - aparece também para pendente_pagamento */}
